...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    foreach ($result as $row){
        $datax = array();
        $datax[$row['promo_name']]['promo_code'] = $row['promo_code'];
        $datax[$row['promo_name']]['site_name'] = $row['site_name'];
        $datax[$row['promo_name']]['site_url'] = $row['site_url'];
